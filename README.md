...
# SoftDesk-API: API providing projects informations
...
This locally-executable API can be installed and executed from [http://localhost:8000/projects](http://localhost:8000/projects/) using the following steps.
